                            ...
                            <div className="row justify-content-center  hackerFont ">
                                <div className="col-md-10">
                                    ...
                                    <ul>
                                        ...
                                        <li>Flags found are of the format <span className="vim-caret">lakshya_ctf.</span> Some of the files may contain just the inner text within the brackets. Make sure you submit it in the format specified. Flag text is not
                                            case sensitive.</li>
